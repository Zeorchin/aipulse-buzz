...
(crontab -l 2>/dev/null; echo "0 9 * * 5 cd /home/zee/Desktop/aipulse-buzz && python3 update_ai_news.py >> /home/zee/Desktop/aipulse-buzz/news_update.log 2>&1") | crontab -
echo "  ✅ Cron job added"
...
echo "     cd /home/zee/Desktop/aipulse-buzz"
...
chmod +x /home/zee/Desktop/aipulse-buzz/update_ai_news.py
chmod +x /home/zee/Desktop/aipulse-buzz/setup_cron.sh
...
echo "   cd /home/zee/Desktop/aipulse-buzz && python3 update_ai_news.py"
echo ""
echo "📜 View logs:"
echo "   tail -f /home/zee/Desktop/aipulse-buzz/news_update.log"
